...
setup(
    ...
    url='https://github.com/elarib/airflow-scheduler-failover-controller',
    download_url=('https://github.com/elarib/airflow-scheduler-failover-controller/tarball/' + __version__)
)
